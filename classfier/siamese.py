...
from classfier.nets.siamese import Siamese as siamese
...
class Siamese(object):
    _defaults = {
        ...
        # -----------------------------------------------------#
        "model_path": 'C:/Users/Lenovo/PycharmProjects/yolov5-wjd/classfier/logs/ep024-loss0.027-val_loss0.197.pth',
        # -----------------------------------------------------#
        #   输入图片的大小。
        # -----------------------------------------------------#
