...
def find_line(image):
    ...
    old_img, close, contours, num, old_img1, dst_img, hsv_img, mask, open = detect_gt_line(image)
...
def GroundTerminal_State(image):
...
if __name__ == "__main__":
    ...
    root_path = "/Users/kerwinji/Desktop/tagline_detect/groundterminal_result/59/wu"
    image_path = os.path.join(root_path, "GroundTerminal18_Pic_2022_05_12_153819_218.bmp")
    image = cv2.imread(image_path)

    old_img, close, contours1, num, old_img1, dst_img, hsv_img, mask, open = detect_gt_line(image)
    ...
    state, old_img3 = GroundTerminal_State(image)
    ...
    # kernel1改成 3  s=0.004对松动的再判断一次 可行