...
def find_line(image):
    ...
    old_img, close, contours, num, old_img1, dst_img, hsv_img, mask, open = detect_f_line(image)
...
if __name__ == "__main__":
    ...
    root_path = "/Users/kerwinji/Desktop/tagline_detect/fastening_result/39/sd"
    image_path = os.path.join(root_path, "Fastening28_Pic_2022_05_13_110156_2.bmp")
    image = cv2.imread(image_path)

    old_img, close, contours1, num, old_img1, dst_img, hsv_img, mask, open = detect_f_line(image)
    ...
    state, old_img3 = Fastening_State(image)
