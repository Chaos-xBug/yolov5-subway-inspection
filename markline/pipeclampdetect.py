...
def find_line(image):
    ...
    old_img, close, contours, num, old_img1, dst_img, hsv_img, mask, open = detect_pc_line(image)
...
if __name__ == "__main__":
    ...
    root_path = "/Users/kerwinji/Desktop/tagline_detect/pipeclamp_result/511/sd"
    image_path = os.path.join(root_path, "PipeClamp43_Pic_2022_05_12_150746_44.bmp")
    image = cv2.imread(image_path)

    old_img, close, contours1, num, old_img1, dst_img, hsv_img, mask, open = detect_pc_line(image)
    ...
    state, old_img3 = PipeClamp_State(image)
    ...
    #  这个相对面积改过了
    # kernel 先33 然后对sd的结果再 55 可以取得一个比较好的效果